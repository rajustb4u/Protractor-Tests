describe('Acumen Add_Site Functionality Tests', function () {
    ...
    it('Test Case AC - 425 Connection - OPĀQ VPN DEVICE', function () {
        ...
        expect(common_Component.getElementErrorByInputName('connection_obj_internal_ip_address_opaq')).toEqual(data.site_data.opaqVPN_InternalIP_errorMsg);
    ...
    it('Test Case AC - 445 Connection - OTHER VPN DEVICE', function () {
        ...
        //capturing the error message and validating when we enter the Connection Internal IP Address with 1 character1.
        expect(common_Component.getElementErrorByInputName('connection_obj_internal_ip_address_other')).toEqual(data.site_data.otherVPN_IP_errorMsg);
    ...
    it('Test Case AC - 440 Connection - DATA CENTER CROSS CONNECT', function () {
        ...
        for (i = 1; i < 3; i++) {
            ...
            browser.sleep(1000);
            //capturing the error message and validating when we enter the Connection Internal IP Address with 1 character1.
            expect(common_Component.getElementErrorByInputName('connection_obj_requested_bandwidth')).toEqual(data.site_data.requested_Bandwidth_errorMsg);
            ...
            expect(common_Component.getElementErrorByInputName('connection_obj_peer_ip_address')).toEqual(data.site_data.peer_IPAddress_errorMsg);
