describe('Acumen Add_DirectoryServices Functionality', function() {
    ...
    it('AC-673 Add Directory Service - Username and Password', function() {
        ...
        /*1. Button *'Add Directory Service'* is disabled * when there is no value in Username field.
         2. Directory Service with *correct USERNAME value* was created. */
        ...
        /*1. Button *'Add Directory Service'* is disabled * when there is no value in Password field.
         2. Entered password is *masked*
         a) Password is *unmasked*
         b) Password is *masked* again
         c) Directory Service was successfully created with provided password ]*/
        ...
        expect(directoryService_Page.showPassword()).toEqual(data.directoryServicesPage_data.directoryServicesPWD);
        console.log('the password match: '+data.directoryServicesPage_data.directoryServicesPWD);
