...
//var logger = require('../test-spec/log.js');
	...
	it('Navigate to standard url filters', function () {
	...
	it('Validating standard url filter exceptions category field', function () {
	...
	it('\nValidating default standard exceptions urls text field ', function () {
		
		console.log("Validating default standard exceptions urls text field");
	...
	it('Validating default standard exceptions users text field ', function () {
		
		console.log("\nValidating default standard exceptions users text field");
		...
		it('Validating default standard exceptions user groups text field ', function () {
		
		console.log("\nValidating default standard exceptions user groups text field");
