describe('Acumen Add_Site Functionality Tests', function () {
    ...
    it('Network - External Secondary Internet Service Provider & ISP Bandwidth', function () {
        ...
        expect(common_Component.getElementErrorByInputName('siteprovider_set_1_name')).toEqual(data.site_data.secondary_ISP_errorMsg);
        ...
        expect(common_Component.getElementErrorByInputName('siteprovider_set_1_ip_address')).toEqual(data.site_data.secondaryISP_ip_errorMsg);
        ...
        expect(common_Component.getElementErrorByInputName('siteprovider_set_1_bandwidth_up')).toEqual(data.site_data.secondaryISP_UP_errorMsg);
        ...
        expect(common_Component.getElementErrorByInputName('siteprovider_set_1_bandwidth_down')).toEqual(data.site_data.secondaryISP_Down_errorMsg);
        browser.sleep(1000);
        ...
        expect(common_Component.getElementErrorByInputName('siteprovider_set_1_gateway_ip_address')).toEqual(data.site_data.secondaryISP_Gateway_errorMsg);
        ...
        browser.sleep(1000);
        //capturing the error message and validating when we enter the Secondary ISP Gateway with 2 characters.
        expect(common_Component.getElementErrorByInputName('siteprovider_set_1_net_mask')).toEqual(data.site_data.secondaryISP_Netmask_errorMsg);
