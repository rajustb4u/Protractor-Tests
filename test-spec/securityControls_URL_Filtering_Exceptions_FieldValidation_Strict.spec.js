...
//var logger = require('../test-spec/log.js');
	...
	it('Navigate to Strict url filters', function () {
	...
	it('Validating Strict url filter exceptions category field', function () {
	...
	it('\nValidating default Strict exceptions urls text field ', function () {
		
		console.log("Validating default Strict exceptions urls text field");
	...
	it('Validating default Strict exceptions users text field ', function () {
		
		console.log("\nValidating default Strict exceptions users text field");
		...
		it('Validating default Strict exceptions user groups text field ', function () {
		
		console.log("\nValidating default Strict exceptions user groups text field");
