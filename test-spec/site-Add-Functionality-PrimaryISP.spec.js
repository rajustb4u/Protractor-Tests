describe('Acumen Add_Site Functionality Tests', function () {
    ...
    it('Network - External Primary Internet Service Provider & ISP Bandwidth', function () {
        ...
        if(expect(common_Component.getElementErrorByName('siteprovider_set_0_name')).toEqual(data.site_data.primary_ISP_errorMsg)) {
        ...
        if(expect(common_Component.getElementErrorByInputName('siteprovider_set_0_ip_address')).toEqual(data.site_data.primaryISP_ip_errorMsg)) {
        ...
        if(expect(common_Component.getElementErrorByName('siteprovider_set_0_bandwidth_up')).toEqual(data.site_data.primaryISP_UP_errorMsg)) {
        ...
        if(expect(common_Component.getElementErrorByInputName('siteprovider_set_0_bandwidth_down')).toEqual(data.site_data.primaryISP_Down_errorMsg)) {
        ...
        if(expect(common_Component.getElementErrorByInputName('siteprovider_set_0_gateway_ip_address')).toEqual(data.site_data.primaryISP_Gateway_errorMsg)) {
        ...
        browser.sleep(1000);
        //capturing the error message and validating when we enter the Primary ISP Gateway with 2 characters.
        if(expect(common_Component.getElementErrorByInputName('siteprovider_set_0_net_mask')).toEqual(data.site_data.primaryISP_Netmask_errorMsg)) {
