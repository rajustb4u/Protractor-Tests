describe('Acumen Add_Site Functionality Tests', function () {
    ...
    it('Test Case AC-69 Validating the Information Section, field validation errors, and checking the Add Site State when those errors exist: ' , function () {
        ...
        if(expect(common_Component.getElementErrorByInputName('name')).toEqual(data.site_data.siteName_errorMsg)) {
        ...
        if(expect(common_Component.getElementErrorByInputName('user_count')).toEqual(data.site_data.userCount_errorMsg)) {
        ...
        if(expect(common_Component.getElementErrorByInputName('name')).toEqual(data.site_data.siteName_RequirederrorMsg)) {
