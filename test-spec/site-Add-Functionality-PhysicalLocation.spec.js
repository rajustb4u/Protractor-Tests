describe('Acumen Add_Site Functionality Tests', function () {
    ...
    it('Test Case AC-71 - Validating PHYSICAL ADDRESS field validation errors, and checking the Add Site State when those errors exist: ', function () {
        ...
        if(expect(common_Component.getElementErrorByName('street_address')).toEqual(data.site_data.address_errorMsg)) {
        ...
        if(expect(common_Component.getElementErrorByInputName('suite_unit')).toEqual(data.site_data.suite_unit_errorMsg)) {
        ...
        if(expect(common_Component.getElementErrorByInputName('city')).toEqual(data.site_data.city_errorMsg)) {
        ...
        browser.sleep(1000);
        if(expect(common_Component.getElementErrorByName('state')).toEqual(data.site_data.state_errorMsg)) {
            browser.sleep(1000);
        ...
        if(expect(common_Component.getElementErrorByInputName('zipcode')).toEqual(data.site_data.zipcode_errorMsg)) {
        ...
        if(expect(sitePage.submitAddSite_State()).toEqual(null)) {
    ...
    it('Test Case AC-413 - POINT OF CONTACT field validation errors, and checking the Add Site State when those errors exist: ', function () {
        ...
        if(expect(common_Component.getElementErrorByInputName('contact_name')).toEqual(data.site_data.contact_name_errorMsg)) {
        ...
        if(expect(common_Component.getElementErrorByInputName('contact_email')).toEqual(data.site_data.contact_email_error_Msg)) {
        ...
        if(expect(common_Component.getElementErrorByInputName('contact_phone_1')).toEqual(data.site_data.contact_phone1_errorMsg)) {
        ...
        if(expect(common_Component.getElementErrorByInputName('contact_phone_2')).toEqual(data.site_data.contact_phone2_errorMsg)) {
